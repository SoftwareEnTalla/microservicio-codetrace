...
import { CodetraceCreatedEvent } from './codetracecreated.event';
import { CodetraceUpdatedEvent } from './codetraceupdated.event';
import { CodetraceDeletedEvent } from './codetracedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'codetrace-created': createEventDefinition('codetrace-created', CodetraceCreatedEvent, EVENT_DEFINITION_OVERRIDES['codetrace-created']),
  'codetrace-updated': createEventDefinition('codetrace-updated', CodetraceUpdatedEvent, EVENT_DEFINITION_OVERRIDES['codetrace-updated']),
  'codetrace-deleted': createEventDefinition('codetrace-deleted', CodetraceDeletedEvent, EVENT_DEFINITION_OVERRIDES['codetrace-deleted']),
